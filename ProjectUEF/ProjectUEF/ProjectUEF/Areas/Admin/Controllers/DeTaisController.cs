...
namespace ProjectUEF.Areas.Admin.Controllers
{
    public class DeTaisController : Controller
    {
        ...
        {
            var data = (from s in db.DeTais select s);
            if (page > 0)
            {
                page = page;
            }
            ...
            {
                dataDMTT = data.OrderByDescending(s => s.ID).Skip(start).Take(limit).Where(a => a.TenDeTai.Contains(searchString));
            }
            return View(dataDMTT.ToList());
        }

        // GET: Admin/DeTais/Details/5
        ...
        // GET: Admin/DeTais/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/DeTais/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ID,TenDeTai,CapDoDeTaiID")] DeTai deTai)
        {
        ...
        // POST: Admin/DeTais/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TenDeTai,CapDoDeTaiID")] DeTai deTai)
        {
            if (ModelState.IsValid)
            {
